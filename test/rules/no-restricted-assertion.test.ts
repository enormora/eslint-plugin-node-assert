...
ruleTester.run('no-restricted-assertion', noRestrictedAssertionRule, {
    valid: [
        ...
        {
            code: "import assert from 'node:assert/strict'; let assertAlias = assert; " +
    ...
    invalid: [
        ...
        {
            code: "import { equal as looselyEqual } from 'node:assert/strict'; " +
        ...
        {
            code: "import assert from 'node:assert/strict'; const assertAlias = assert; " +
                'assertAlias.equal(actualValue, expectedValue);',
            options: restrictedLegacyEqualityOptions,
            errors: [
                {
        ...
        {
            code: "import assert from 'node:assert/strict'; const { equal } = assert; " +
        ...
        {
            code: "import assert from 'node:assert/strict'; const { equal: looselyEqual } = assert; " +
                'looselyEqual(actualValue, expectedValue);',
            options: restrictedLegacyEqualityOptions,
            errors: [
                {
        ...
        {
            code: "import assert from 'node:assert/strict'; const equalityMethodName = 'equal'; " +
        ...
        {
            code: "import assert from 'node:assert'; const { strict: strictAssert } = assert; " +
