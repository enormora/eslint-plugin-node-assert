...
[![GitHub Actions status](https://github.com/enormora/eslint-plugin-node-assert/workflows/CI/badge.svg)](https://github.com/enormora/eslint-plugin-node-assert/actions)
