...
type NamespaceBindings<TMeta> = Map<string, NamespaceBinding<TMeta>>;
type MethodBindings<TMeta> = Map<string, MethodBinding<TMeta>>;

type TrackerState<TMeta> = {
    readonly namespaces: NamespaceBindings<TMeta>;
    readonly methodBindings: MethodBindings<TMeta>;
