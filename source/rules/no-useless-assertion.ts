...
/* eslint-disable @typescript-eslint/consistent-type-definitions, @typescript-eslint/no-use-before-define, perfectionist/sort-union-types -- internal constant-evaluator helpers rely on recursive readonly shapes and mutual recursion */
...
const COVERED_METHOD_NAMES: ReadonlySet<string> = new Set([
    ...ONE_ARGUMENT_METHOD_NAMES,
    ...TWO_ARGUMENT_METHOD_NAMES
]);
...
const UNARY_OPERATOR_EVALUATORS: Readonly<
    Record<TSESTree.UnaryExpression['operator'], (value: ConstantValue) => ConstantEvaluation>
> = {
...
): NotEvaluatable | { readonly propertyName: string; readonly propertyValue: ConstantValue; } {
...
/* eslint-enable @typescript-eslint/consistent-type-definitions, @typescript-eslint/no-use-before-define, perfectionist/sort-union-types -- end internal constant-evaluator helper exemptions */
